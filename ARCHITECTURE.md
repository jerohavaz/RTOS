...
The trace API separates instrumentation from the functional RTOS control flow. RTOS services, kernel code, and architecture-specific code generate events through trace hooks, which are then forwarded to the configured trace backends.
